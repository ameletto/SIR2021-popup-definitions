...
$(function () {
	...
	*/
	...
	var RECRUITMENT_BANNER_HTML = {
		en: '<div class="bannercontent">' +
			'<div class="recruit-main">' +
			'<span>Join us for a procurement event on 25th July and find out more about digital and IT procurement opportunities in The National Archives’ Digital Services Directorate: <a href="https://www.find-tender.service.gov.uk/Notice/033999-2025?origin=Dashboard" target="_blank" style="color: wheat;">Digital &amp; IT Opportunities at The National Archives - Find a Tender</a></span>' +
			'</div>' +
			'<ul>' +
			'<li><a href="' + RECRUITMENT_URL + '" target="_blank" class="join">Click for more info</a></li>' +
			'<li><a href="#" class="recruitment-close">Close</a></li>' +
			'</ul>' +
			'</div>',
		cy: '<div class="bannercontent">' +
